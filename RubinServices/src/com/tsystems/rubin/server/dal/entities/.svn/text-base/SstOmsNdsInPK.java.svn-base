 ...
 * 
 * File Name: com.tsystems.rubin.server.dal.entities.SstOmsNdsInPK.java
...
@Embeddable
public class SstOmsNdsInPK implements Serializable {
		...
		public boolean equals(Object o) {
			...
			if ( ! (o instanceof SstOmsNdsInPK)) {
				return false;
			}
			SstOmsNdsInPK other = (SstOmsNdsInPK) o;
