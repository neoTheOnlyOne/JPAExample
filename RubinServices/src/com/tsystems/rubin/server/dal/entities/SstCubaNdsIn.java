...
@Entity
@Table(name="SST_CUBA_NDS_IN")
public class SstCubaNdsIn implements Serializable {
	@EmbeddedId
	private SstCubaNdsInPK sstCubaNdsInPK;
	...
	/**
	 * @return the sstCubaNdsInPK
	 */
	public SstCubaNdsInPK getSstCubaNdsInPK() {
		return sstCubaNdsInPK;
	}


	/**
	 * @param sstCubaNdsInPK the sstCubaNdsInPK to set
	 */
	public void setSstCubaNdsInPK(SstCubaNdsInPK sstCubaNdsInPK) {
		this.sstCubaNdsInPK = sstCubaNdsInPK;
	}
