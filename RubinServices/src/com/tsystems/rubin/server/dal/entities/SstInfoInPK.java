 ...
 * 
 * File Name: com.tsystems.rubin.server.dal.entities.SstInfoInPK.java
...
@Embeddable
public class SstInfoInPK implements Serializable {
		...
		public boolean equals(Object o) {
			...
			if ( ! (o instanceof SstInfoInPK)) {
				return false;
			}
			SstInfoInPK other = (SstInfoInPK) o;
