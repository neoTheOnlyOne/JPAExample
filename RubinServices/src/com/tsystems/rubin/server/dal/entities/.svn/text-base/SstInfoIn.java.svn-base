...
@Entity
@Table(name="SST_INFO_IN")
public class SstInfoIn implements Serializable {
	@EmbeddedId
	private SstInfoInPK sstInfoInPK;
	...
	/**
	 * @return the sstInfoInPK
	 */
	public SstInfoInPK getSstInfoInPK() {
		return sstInfoInPK;
	}


	/**
	 * @param sstInfoInPK the sstInfoInPK to set
	 */
	public void setSstInfoInPK(SstInfoInPK sstInfoInPK) {
		this.sstInfoInPK = sstInfoInPK;
	}
