 ...
 * 
 * File Name: com.tsystems.rubin.server.dal.entities.SstNdsCubaOutPK.java
...
@Embeddable
public class SstNdsCubaOutPK implements Serializable {
		...
		public boolean equals(Object o) {
			...
			if ( ! (o instanceof SstNdsCubaOutPK)) {
				return false;
			}
			SstNdsCubaOutPK other = (SstNdsCubaOutPK) o;
