 ...
 * 
 * File Name: com.tsystems.rubin.server.dal.entities.SstCubaNdsInPK.java
...
@Embeddable
public class SstCubaNdsInPK implements Serializable {
		...
		public boolean equals(Object o) {
			...
			if ( ! (o instanceof SstCubaNdsInPK)) {
				return false;
			}
			SstCubaNdsInPK other = (SstCubaNdsInPK) o;
