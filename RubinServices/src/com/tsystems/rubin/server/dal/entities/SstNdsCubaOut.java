...
@Entity
@Table(name="SST_NDS_CUBA_OUT")
public class SstNdsCubaOut implements Serializable {
	@EmbeddedId
	private SstNdsCubaOutPK sstNdsCubaOutPK;
	...
	/**
	 * @return the sstNdsCubaOutPK
	 */
	public SstNdsCubaOutPK getSstNdsCubaOutPK() {
		return sstNdsCubaOutPK;
	}



	/**
	 * @param sstNdsCubaOutPK the sstNdsCubaOutPK to set
	 */
	public void setSstNdsCubaOutPK(SstNdsCubaOutPK sstNdsCubaOutPK) {
		this.sstNdsCubaOutPK = sstNdsCubaOutPK;
	}
