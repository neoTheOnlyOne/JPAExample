 ...
 * 
 * File Name: com.tsystems.rubin.server.dal.entities.SstInfoOutPK.java
...
@Embeddable
public class SstInfoOutPK implements Serializable {
		...
		public boolean equals(Object o) {
			...
			if ( ! (o instanceof SstInfoOutPK)) {
				return false;
			}
			SstInfoOutPK other = (SstInfoOutPK) o;
